<?php $title="Карта сайта"; require_once "../templates/head.php"; ?>
<body id="page6">
<div id="main">
<!-- HEADER -->
					...
					<div class="left-bot-corner">
						<div class="inner">
							<div class="box1 alt">
								<div class="inner">
									<h4><b></b> </h4>
									<p class="p0">Удобное расположение будет удобным для каждого пользователя и сможет помочь найти нужну страницу сайта и вернуться к предыдущим разделам</p>
								</div>
							</div>
						</div>
					</div>
